...
public class SkeletonCommanderSpawnsMethodProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		entity.getPersistentData().putBoolean("mobCommander", true);
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = MonstersLevelUpModEntities.SPIDER_MOTHER.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
