...
public class ZombieJuggernautSpawnsWithEggProcedure {
	public static void execute(Entity entityinstance) {
		if (entityinstance == null)
			return;
		entityinstance.getPersistentData().putBoolean("juggernaut", true);
		...
		if (!(((LivingEntity) entityinstance).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE)
			...
			((LivingEntity) entityinstance).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE)
