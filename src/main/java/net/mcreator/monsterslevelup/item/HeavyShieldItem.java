...
import net.mcreator.monsterslevelup.procedures.HeavyShieldToolInInventoryTickProcedure;
...
public class HeavyShieldItem extends ShieldItem {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		HeavyShieldToolInInventoryTickProcedure.execute(entity, itemstack);
	}
}
