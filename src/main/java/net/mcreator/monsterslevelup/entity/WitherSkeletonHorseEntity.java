...
public class WitherSkeletonHorseEntity extends Monster implements GeoEntity {
	...
	public WitherSkeletonHorseEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MonstersLevelUpModEntities.WITHER_SKELETON_HORSE.get(), world);
	}

	public WitherSkeletonHorseEntity(EntityType<WitherSkeletonHorseEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
		setMaxUpStep(1f);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		WitherSkeletonHorseOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		WitherSkeletonHorseOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		SpawnPlacements.register(MonstersLevelUpModEntities.WITHER_SKELETON_HORSE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WitherSkeletonHorseEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
