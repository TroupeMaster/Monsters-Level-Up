...
import net.mcreator.monsterslevelup.potion.ChargeMobEffect;
...
public class MonstersLevelUpModMobEffects {
	...
	public static final RegistryObject<MobEffect> CHARGE = REGISTRY.register("charge", () -> new ChargeMobEffect());
}
