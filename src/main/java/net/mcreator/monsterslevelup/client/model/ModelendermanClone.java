...
public class ModelendermanClone<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("monsters_level_up", "modelenderman_clone"), "main");
	...
	public ModelendermanClone(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -25.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-0.5F)).texOffs(0, 16).addBox(-4.0F, -21.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-1.0F)),
